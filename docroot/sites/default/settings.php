 ...
 * @endcode
 */
$settings['hash_salt'] = 'KG59Dr50h-DOxuGB9TWoRHzaWX1nSPYYIsXHAzJeBDQHgaxvp9UR5TLjT29-GxBQjeTW0t07KQ';
...
if (file_exists($app_root . '/' . $site_path . '/settings.cp.php')) {
  include $app_root . '/' . $site_path . '/settings.cp.php';
}
